...
Files are Emacs Lisp code, and Org mode files with embedded Emacs Lisp.
For each prompt input, write the prompt to file PROMPTS.md.
When asked to write a commit message, add the co-authored by claude line.
