...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company company-web devdocs dockerfile-mode eldoc eldoc-box elisp-autofmt emmet-mode flycheck form-feed-st
             highlight-parentheses ivy lsp-mode lsp-origami org org-contacts org-modern org-special-block-extras origami
             projectile smart-mode-line smart-mode-line-powerline-theme sql-indent tree-sitter whitespace-cleanup-mode
             xkcd))
...
(custom-set-faces
 ...
 '(fixed-pitch ((t nil)))
 '(line-number-major-tick ((t (:background "gray85" :weight bold :height 1.0))))
 '(line-number-minor-tick ((t (:background "gray91" :slant italic :height 1.0)))))
