...
(custom-set-variables
 ...
 '(org-modules
   '(ol-bbdb ol-bibtex ol-docview ol-doi ol-eww ol-gnus ol-info ol-irc
             ol-mhe ol-rmail ol-w3m org-mac-iCal))
 ...
 '(safe-local-variable-directories
   '("/Users/adrianflanagan/Devel/personal/people/"
     "~/org/projects/Springbok/"))
 '(safe-local-variable-values
   '((elisp-lint-ignored-validators 'package-lint)
     ...
     (lsp-typescript-sdk
      . "/Users/adrianflanagan/Devel/mobelux/MMS/gatsby-source-mms/node_modules/typescript/bin")
     (org-todo-keywords quote
                        ((sequence "TODO" "IN PROGRESS" "DEFERRED"
                                   "CLIENT" "|" "DONE" "CANCELED")))
     (org-todo-keywords quote
                        ((sequence "TODO" "IN PROGRESS" "DEFERRED"
                                   "ON HOLD" "NEEDS INPUT" "|" "DONE"
                                   "CANCELED")))
     (org-todo-keywords quote
 ...
 '(tree-sitter-major-mode-language-alist
   '((actionscript-mode . actionscript) (ada-mode . ada)
     ...
     (css-mode . css) (csv-mode . csv) (elm-mode . elm)
     ...
     (typescript-ts-mode . typescript) (ninja-mode . ninja)
     (noir-mode . noir) (ocaml-mode . ocaml) (org-mode . org)
     (pascal-mode . pascal) (perl-mode . perl) (php-mode . php)
     (qss-mode . css) (prisma-mode . prisma) (python-mode . python)
     (pygn-mode . pgn) (racket-mode . racket) (rjsx-mode . javascript)
     (rst-mode . rst) (ruby-mode . ruby) (rust-mode . rust)
     (rustic-mode . rust) (scala-mode . scala) (scheme-mode . scheme)
     (solidity-mode . solidity) (smithy-mode . smithy)
     (sql-mode . sql) (swift-mode . swift) (tablegen-mode . tablegen)
     (toml-mode . toml) (conf-toml-mode . toml) (tcl-mode . tcl)
     (tuareg-mode . ocaml) (twig-mode . twig) (tsx-ts-mode . tsx)
 ...
 '(treesit-auto-langs
   '(awk bash bibtex blueprint c c-sharp clojure cmake commonlisp cpp css
         ...
         javascript json julia kotlin lua make markdown nix nu org
         perl proto python r ruby rust scala sql surface toml tsx
