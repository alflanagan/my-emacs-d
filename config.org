...
(use-package
 ...
 ;; TODO: in :config section, check for existence of "uv" and "mise" and don't
...
Displays available key bindings in a popup after pressing a prefix key.
Built-in as of Emacs 30; ~:ensure nil~ defers to the bundled copy in the
~lisp/emacs-which-key~ submodule (or the built-in on Emacs 30+).

#+begin_src emacs-lisp
(use-package which-key
  :ensure nil
  :load-path "my_emacs/lisp/emacs-which-key"
...
#+begin_src emacs-lisp
(use-package markdown-ts-mode :defer t)
#+end_src
